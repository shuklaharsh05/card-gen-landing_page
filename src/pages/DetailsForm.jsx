          ...
          <div className="max-w-lg mx-auto">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-4 sm:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Services section (repeating) - generic (non-Link Pro) */}
                {config.categoryId !== "link-pro" &&
                  (config.arrayFieldKeys || []).includes("services") && (
                    <div className="border-t border-gray-100 pt-4">
                      <h2 className="text-sm font-semibold text-gray-900 mb-2">
                        Services
                      </h2>
                      <p className="text-xs text-gray-500 mb-3">
                        Add the services you offer. Each service can include a name, description and price.
                      </p>
                      <div className="space-y-3">
                ...
                {/* Products section (repeating) - generic (non-Link Pro) */}
                {config.categoryId !== "link-pro" &&
                  (config.arrayFieldKeys || []).includes("products") && (
                    <div className="border-t border-gray-100 pt-4">
                      <h2 className="text-sm font-semibold text-gray-900 mb-2">
                        Products
                      </h2>
                      <p className="text-xs text-gray-500 mb-3">
                        Add the products you want to show on your card. Each product can include a name and price.
                      </p>
                      <div className="space-y-3">
                ...
                {/* Link Pro: ourServices */}
                {config.categoryId === "link-pro" &&
                  (config.arrayFieldKeys || []).includes("ourServices") && (
                    <div className="border-t border-gray-100 pt-4">
                      <h2 className="text-sm font-semibold text-gray-900 mb-2">
                        Services
                      </h2>
                      <p className="text-xs text-gray-500 mb-3">
                        Add the services you offer. Each service can include a title and description.
                      </p>
                      <div className="space-y-3">
                ...
                {/* Link Pro: ourProducts */}
                {config.categoryId === "link-pro" &&
                  (config.arrayFieldKeys || []).includes("ourProducts") && (
                    <div className="border-t border-gray-100 pt-4">
                      <h2 className="text-sm font-semibold text-gray-900 mb-2">
                        Products
                      </h2>
                      <p className="text-xs text-gray-500 mb-3">
                        Add the products you want to show on your card. Each product can include a title, description and price.
                      </p>
                      <div className="space-y-3">
